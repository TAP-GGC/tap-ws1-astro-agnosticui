...
images:
 [
    { src: "./aidivateam.png", alt: "Ai Diva Logo" },
    { src: "./aidivalogo.png", alt: "Ai Diva Logo" },
    { src: "./openailogo.png", alt: "Ai Diva Logo" },
    { src: "./ScienceFestival.png", alt: "Ai Diva Logo" },
    { src: "./TapExpo.png", alt: "Ai Diva Logo" },
 ]
imageLogoLight: aidivalogo.png
imageTeam: ./aidivateam.png
---

import { Image } from "astro:assets";
import GroupPhoto from './aidivateam.png';

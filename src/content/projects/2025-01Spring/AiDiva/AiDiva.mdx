---
title: Teaching prompt engineering and Ai ethics
shortTitle: AI Diva
id: ai-diva
...
students: [
   "gabriel-sosa", "rebecca-rahman", "my-tran"
]
instructors: [
   "cengiz-gunay", "cindy-robertson"
]
techs: [
   "ai","api","chatbot","artificial intelligence","html",
   "css","javascript","python"
]
videos: [
   {src: "mJm2OKTWRPc?si=TjyDNReB02XT_1Z4", caption: "AiDivaCommercial"},
   {src: "DXfXpEJkKxc?si=aF21R5Ybrj832TEB", caption: " AI Diva demo "},
   {src: "O4iwbVIdOGc?si=LPps_pGDQjBRQp_e", caption: " AiDivaWorkshop "},
]
events: [
   "create","stars","tap expo","atlanta science festival","create symposium"
]
semester: spring
year: 2025
levels: [
   "k12","college","middle-school","high-school"
]
difficulty: [ "beginner"]
durationMins: []
publishedDate: 2025-04-24
relatedIds: [
   "art","mbot mega","autobots"
]
...
videoAd: "XkTjLWIXTuc?si=oG3VTfKH2-xuv4_K"
...
<Clip src="mJm2OKTWRPc" showIframe={true} />
...
### Team Members:
<Photo src={GroupPhoto.src} alt="Ai Diva Group Photo" caption="Left to Right: Gabe Sosa, Rebecca Rahim, My Tran"/>

<Image src={GroupPhoto} alt="Ai Diva Group Photo" style="height: 80vh; width: 80vw"/>
...
#### OpenAI API
<Logo src={OpenAI.src} alt="OpenAILogo"/>
...
#### <a href="https://tap-ggc.github.io/AiDiva/" target="_blank" rel="noopener noreferrer">Ai Diva</a>
*This workshop is strongly recommended in a Computer Lab.*<br /><br />

#### Workshop and Materials
- <a href="https://github.com/TAP-GGC/AiDiva/blob/main/documents/workshop%20materials/Ai_Diva_Slides.pdf" target="_blank" rel="noopener noreferrer">Ai Diva Slides PDF</a>
- Demo Video
<Clip src="DXfXpEJkKxc" showIframe={true} />
<div style="margin: 40px;"></div>
- Workshop for Student Demo
<Clip src="O4iwbVIdOGc" showIframe={true} />
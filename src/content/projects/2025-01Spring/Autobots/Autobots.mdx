---
title: A simulation of Convolutional Neural Network for Self-Driving Cars
shortTitle: Autobots
id: autobots
...
videos: [
  {src: "GyAizXZ1A8Q?si=q1qXjy6dgoX3LeOW", caption: " Autobots Project Demo "} ,
  {src: "eWBbS57NUfY?si=YrSZZ_e_1fmkTpDO", caption: " Autobots Workshop Video "} ,
]
events: []
semester: spring
year: 2025
...
relatedIds: [
  "jedi-sphero", "dancing sphero", "mbot mega", "mblock", "thebeepbops", 
  "ai-diva", "wanda", "code-nator", "artify-ai", "drone-reality", "ball-is-life",  "tech-gold-fish"
]
images:
  [
...
videoAd: "0ng56N1qFLg?si=rFkG7cg4Sow5CVP2"
---

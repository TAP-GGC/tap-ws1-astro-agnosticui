...
students: [
  "anh-tang",  "julissa-valdez-ramos",  "jean-makita-mbama"
]
instructors: [
  "cindy-robertson",   "anca-doloc-mihu"
] 
techs: [
  "scratch",  "makey makey",  "conduction"
]
videos: [
  {src: "Mtsre0iMStM?si=A29qCY9DqdqmOKTC", caption: "Full TMNT Workshop"},
  {src: "mA80Aa55t-U?si=QWx6jf4EOqGB9xPd" , caption: "Space Mechanic Project Demo"},
  {src: "v-GUbj7DMEE?si=-d8CyQTFfGZoYMae", caption: "General Scratch Guide"},
]
events: [
    "Tap Expo",     "Atlanta Science Festival",
    "Super Saturday Series (S3)",    "Class Workshops"
]
semester: spring
year: 2024
levels: [
  "k-12",  "non-Stem",  "undergraduate",  "middle-school",  "college"
] 
difficulty: [  "beginner"] 
durationMins: [  60]
...
images: [
  {src: './NinjaTurtlesS3.png', alt: 'S3 Workshop'},
   {src: './NinjaTurtlesASF2.png',alt: 'Atlanta Science Festival'}
]
imageLogoLight: ./SpaceMechanicLogo-T.png
imageLogoDark: ./SpaceMechanicLogo-T.png
imageTeam: ./ninjaturtlesGroupPhoto.png
videoAd: "mA80Aa55t-U?si=QWx6jf4EOqGB9xPd"
curator: ["trung-dao","julissa-v-ramos", "anh-tang"]
---
...
## Team members
<Photo src={ninjaturtlesGroupPhoto.src} alt="Ninja Turtles Photo" caption="From left to right: Anh Tang , Julissa Valdez-Ramos , Jean Makita Mbama"/>
<br />
...
<Logo src={scratchlogo.src} link="https://scratch.mit.edu/" alt="Scratch"/>
